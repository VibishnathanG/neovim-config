...
show_help = function()
  ...
  vim.notify("📘 Help opened — Press 'q' or Esc to close. If started from welcome, the startup menu will return.",
    vim.log.levels.INFO)
end
...
map("n", "<C-a>", function()
  ...
  vim.notify("🔎 Entire buffer selected.", vim.log.levels.INFO)
end)
